...
urlpatterns = [
    ...
    path('check-pending-referral/<str:patient_id>/', views.check_pending_referral, name='check_pending_referral'),
    ...
    path('api/search-diseases/', views.search_diseases, name='search_diseases'),
    path('api/disease/<int:disease_id>/', views.get_disease_details, name='get_disease_details'),
    ...
    path('referral/<int:referral_id>/details/', views.get_referral_details, name='get_referral_details'),
