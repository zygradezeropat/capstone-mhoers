...
# ========= Config =========
CSV_CANDIDATES = [
    os.path.join('MHOERS', 'sample_datasets', 'New_corella_datasets_4.csv'),
    os.path.join('sample_datasets', 'New_corella_datasets_4.csv'),
    'New_corella_datasets_4.csv'
]
MEDICAL_KEYWORDS = [
...
numeric_features = ['AGE', 'ADMISSION_TIME_MINUTES', 'ICD10_ENCODED']
